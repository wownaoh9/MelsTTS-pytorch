...
from models.delightful_tts.conformer.constants import LEAKY_RELU_SLOPE
from models.delightful_tts.conformer.conv_blocks import ConvTransposed
...
class PhonemeProsodyPredictor(Module):
    ...
    def __init__(
        ...
        self.d_model = model_config["ConformerFgPredictor"]["n_hidden"]
        kernel_size = model_config["ConformerFgPredictor"]["predictor_kernel_size"]
        dropout = model_config["ConformerFgPredictor"]["p_dropout"]
